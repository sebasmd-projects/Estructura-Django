"""
Django settings for app_nombre_del_proyecto project.
...
LOCAL_APPS = (
    'apps.autentificacion.login',
    'apps.autentificacion.olvide_la_contrasena',
    'apps.autentificacion.registro',
    #El resto... son un monton de apps
)
...
ROOT_URLCONF = 'app_nombre_del_proyecto.urls'
...
WSGI_APPLICATION = 'app_nombre_del_proyecto.wsgi.application'
